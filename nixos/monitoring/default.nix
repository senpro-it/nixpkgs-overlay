        ...
        inputs = {
          ...
          snmp = lib.mkIf cfg.monitoring.telegraf.inputs.snmp.enable [
            ...
            (lib.mkIf cfg.monitoring.telegraf.inputs.snmp.vendors.reddox.endpoints.self.enable {
              ...
              retries = 5;
              field = [
                { name = "SmtpReceiverConnectionsIn"; oid = "REDDOX-MIB::SmtpReceiverConnectionsIn"; }
                { name = "SmtpReceiverConnectionsOut"; oid = "REDDOX-MIB::SmtpReceiverConnectionsOut"; }
                { name = "SmtpReceiverMessagesReceivedIn"; oid = "REDDOX-MIB::SmtpReceiverMessagesReceivedIn"; }
                { name = "SmtpReceiverMessagesReceivedOut"; oid = "REDDOX-MIB::SmtpReceiverMessagesReceivedOut"; }
                { name = "SmtpReceiverBytesReceivedIn"; oid = "REDDOX-MIB::SmtpReceiverBytesReceivedIn"; }
                { name = "SmtpReceiverBytesReceivedOut"; oid = "REDDOX-MIB::SmtpReceiverBytesReceivedOut"; }
                { name = "SmtpReceiverActiveConnections"; oid = "REDDOX-MIB::SmtpReceiverActiveConnections"; }
                { name = "RejectedMessagesBecauseIpBlacklisted"; oid = "REDDOX-MIB::RejectedMessagesBecauseIpBlacklisted"; }
                { name = "RejectedMessagesBecauseAntiSpoofing"; oid = "REDDOX-MIB::RejectedMessagesBecauseAntiSpoofing"; }
                { name = "RejectedMessagesBecauseSpf"; oid = "REDDOX-MIB::RejectedMessagesBecauseSpf"; }
                { name = "ValidDkimSignatures"; oid = "REDDOX-MIB::ValidDkimSignatures"; }
                { name = "InvalidDkimSignatures"; oid = "REDDOX-MIB::InvalidDkimSignatures"; }
                { name = "SmtpSenderConnectionsIn"; oid = "REDDOX-MIB::SmtpSenderConnectionsIn"; }
                { name = "SmtpSenderConnectionsOut"; oid = "REDDOX-MIB::SmtpSenderConnectionsOut"; }
                { name = "SmtpSenderMessagesSentIn"; oid = "REDDOX-MIB::SmtpSenderMessagesSentIn"; }
                { name = "SmtpSenderMessagesSentOut"; oid = "REDDOX-MIB::SmtpSenderMessagesSentOut"; }
                { name = "SmtpSenderBytesSentIn"; oid = "REDDOX-MIB::SmtpSenderBytesSentIn"; }
                { name = "SmtpSenderBytesSentOut"; oid = "REDDOX-MIB::SmtpSenderBytesSentOut"; }
                { name = "SmtpSenderActiveConnections"; oid = "REDDOX-MIB::SmtpSenderActiveConnections"; }
                { name = "MessagesWaitingForProcessing"; oid = "REDDOX-MIB::MessagesWaitingForProcessing"; }
                { name = "MessagesWaitingForDelivery"; oid = "REDDOX-MIB::MessagesWaitingForDelivery"; }
                { name = "ArchiveQueueLength"; oid = "REDDOX-MIB::ArchiveQueueLength"; }
                { name = "RssMemoryUsageApplianceManager"; oid = "REDDOX-MIB::RssMemoryUsageApplianceManager"; }
                { name = "RssMemoryUsageMailDepot"; oid = "REDDOX-MIB::RssMemoryUsageMailDepot"; }
                { name = "RssMemoryUsageSystemManager"; oid = "REDDOX-MIB::RssMemoryUsageSystemManager"; }
                { name = "RssMemoryyUsageComplianceLog"; oid = "REDDOX-MIB::RssMemoryyUsageComplianceLog"; }
                { name = "RssMemoryUsageSpamfinder"; oid = "REDDOX-MIB::RssMemoryUsageSpamfinder"; }
                { name = "RssMemoryUsageClamav"; oid = "REDDOX-MIB::RssMemoryUsageClamav"; }
                { name = "RssMemoryUsageMongoDB"; oid = "REDDOX-MIB::RssMemoryUsageMongoDB"; }
                { name = "RssMemoryUsageHaProxy"; oid = "REDDOX-MIB::RssMemoryUsageHaProxy"; }
                { name = "RssMemoryUsageMailSealer"; oid = "REDDOX-MIB::RssMemoryUsageMailSealer"; }
                { name = "RssMemoryUsageSmtpReceiver"; oid = "REDDOX-MIB::RssMemoryUsageSmtpReceiver"; }
                { name = "RssMemoryUsageSmtpSender"; oid = "REDDOX-MIB::RssMemoryUsageSmtpSender"; }
                { name = "RssMemoryUsageLogManager"; oid = "REDDOX-MIB::RssMemoryUsageLogManager"; }
                { name = "RssMemoryUsageReddcryptGateway"; oid = "REDDOX-MIB::RssMemoryUsageReddcryptGateway"; }
                { name = "RssMemoryUsageMailDepotIndex"; oid = "REDDOX-MIB::RssMemoryUsageMailDepotIndex"; }
                { name = "CpuUsageApplianceManager"; oid = "REDDOX-MIB::CpuUsageApplianceManager"; }
                { name = "CpuUsageMailDepot"; oid = "REDDOX-MIB::CpuUsageMailDepot"; }
                { name = "CpuUsageSystemManager"; oid = "REDDOX-MIB::CpuUsageSystemManager"; }
                { name = "CpuUsageComplianceLog"; oid = "REDDOX-MIB::CpuUsageComplianceLog"; }
                { name = "CpuUsageSpamfinder"; oid = "REDDOX-MIB::CpuUsageSpamfinder"; }
                { name = "CpuUsageClamav"; oid = "REDDOX-MIB::CpuUsageClamav"; }
                { name = "CpuUsageMongoDB"; oid = "REDDOX-MIB::CpuUsageMongoDB"; }
                { name = "CpuUsageHaProxy"; oid = "REDDOX-MIB::CpuUsageHaProxy"; }
                { name = "CpuUsageMailSealer"; oid = "REDDOX-MIB::CpuUsageMailSealer"; }
                { name = "CpuUsageSmtpReceiver"; oid = "REDDOX-MIB::CpuUsageSmtpReceiver"; }
                { name = "CpuUsageSmtpSender"; oid = "REDDOX-MIB::CpuUsageSmtpSender"; }
                { name = "CpuUsageLogManager"; oid = "REDDOX-MIB::CpuUsageLogManager"; }
                { name = "CpuUsageReddcryptGateway"; oid = "REDDOX-MIB::CpuUsageReddcryptGateway"; }
                { name = "CpuUsageMailDepotIndex"; oid = "REDDOX-MIB::CpuUsageMailDepotIndex"; }
                { name = "UptimeApplianceManager"; oid = "REDDOX-MIB::UptimeApplianceManager"; }
                { name = "UptimeMailDepot"; oid = "REDDOX-MIB::UptimeMailDepot"; }
                { name = "UptimeSystemManager"; oid = "REDDOX-MIB::UptimeSystemManager"; }
                { name = "UptimeComplianceLog"; oid = "REDDOX-MIB::UptimeComplianceLog"; }
                { name = "UptimeSpamfinder"; oid = "REDDOX-MIB::UptimeSpamfinder"; }
                { name = "UptimeClamav"; oid = "REDDOX-MIB::UptimeClamav"; }
                { name = "UptimeMongoDB"; oid = "REDDOX-MIB::UptimeMongoDB"; }
                { name = "UptimeHaProxy"; oid = "REDDOX-MIB::UptimeHaProxy"; }
                { name = "UptimeMailSealer"; oid = "REDDOX-MIB::UptimeMailSealer"; }
                { name = "UptimeSmtpReceiver"; oid = "REDDOX-MIB::UptimeSmtpReceiver"; }
                { name = "UptimeSmtpSender"; oid = "REDDOX-MIB::UptimeSmtpSender"; }
                { name = "UptimeLogManager"; oid = "REDDOX-MIB::UptimeLogManager"; }
                { name = "UptimeReddcryptGateway"; oid = "REDDOX-MIB::UptimeReddcryptGateway"; }
                { name = "UptimeMailDepotIndex"; oid = "REDDOX-MIB::UptimeMailDepotIndex"; }
                { name = "OpenFilesTotal"; oid = "REDDOX-MIB::OpenFilesTotal"; }
                { name = "OpenFilesContainer"; oid = "REDDOX-MIB::OpenFilesContainer"; }
                { name = "OpenFilesIndex"; oid = "REDDOX-MIB::OpenFilesIndex"; }
