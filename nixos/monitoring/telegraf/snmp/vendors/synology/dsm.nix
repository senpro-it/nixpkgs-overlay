...
let
  ...
  /* Synology DSM config subtree. */
  deviceCfg = config.senpro.monitoring.telegraf.inputs.snmp.vendors.synology.dsm;

  /* Build the Telegraf SNMP input for one Synology DSM agent.
