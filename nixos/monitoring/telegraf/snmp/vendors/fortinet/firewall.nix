...
let
  ...
  /* Fortinet firewall config subtree. */
  deviceCfg = config.senpro.monitoring.telegraf.inputs.snmp.vendors.fortinet.firewall;

  /* Build the Telegraf SNMP input for one firewall agent.
